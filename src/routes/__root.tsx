...
const META_PIXEL_ID = "1931281277521079";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Longevin · Clínica de Medicina Integrada e Longevidade" },
      {
        name: "description",
        content:
          "Clínica boutique de medicina integrada em Fortaleza. Atendimento multidisciplinar, humano e personalizado para a sua jornada de saúde e longevidade.",
      },
      { name: "author", content: "Longevin" },
      { property: "og:site_name", content: "Longevin" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Longevin",
          description:
            "Clínica de medicina integrada e longevidade em Fortaleza, Ceará.",
          address: {
            "@type": "PostalAddress",
